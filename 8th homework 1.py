...
plot(t_first_array,theta_first_array,label=r'$\theta_0=\frac{\pi}{4}$')
plot(t_second_array,theta_second_array,label=r'$\theta_0=\frac{\pi}{2}$')
plot(t_third_array,theta_third_array,label=r'$\theta_0=\frac{\pi}{8}$')
